...
context("theta_benford")

test_that("theta_benford(1) 1", {
  expect_equal(
    theta_benford(1),
...
test_that("theta_benford(1) 2", {
  expect_equal(
    round(theta_benford(1), 3),
    c(0.301, 0.176, 0.125, 0.097, 0.079, 0.067, 0.058, 0.051, 0.046)
  )
}
)

test_that("theta_benford(2) 1", {
  expect_equal(
    theta_benford(2),
...
test_that("theta_benford(2) 2", {
  expect_equal(
    round(theta_benford(2), 3),
