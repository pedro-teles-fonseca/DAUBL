...
You can install the released version of daubl from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("daubl")
```
...
devtools::install_github("pedro-teles-fonseca/daubl")
```
## Example
